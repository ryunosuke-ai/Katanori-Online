...
def send_to_server_pc3(text_data):
    """ PC3のSocketIOサーバーにテキストデータを送信 """
    try:
        sio.emit('text_to_speech', {'text': text_data})
        print("PC3にテキストを送信しました:", text_data)
    except Exception as e:
        print("PC3への送信エラー:", e)
...
def receive_text():
    ...
    # PC3のSocketIOサーバーに結果を送信
    send_to_server_pc3(response_text)
